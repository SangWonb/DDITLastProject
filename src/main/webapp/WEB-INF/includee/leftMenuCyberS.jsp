...
<div class="mdk-drawer js-mdk-drawer sidebar-brand sidebar sidebar-dark-pickled-bluewood sidebar-left ps"
    ...
    <div class="mdk-drawer__content">
        <div class=""
            ...
            <div class="sidebar-heading text-white sidebar sidebar-dark-pickled-bluewood sidebar-left ps">Student</div>
            <ul class="sidebar-menu bg-danger">

                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button"
                        href='<c:url value="/student/cyber/syllabus/syllabusDetail/${cyberLecCode }"/>'>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button"
                        href='<c:url value="/student/cyber/onlinelecture/onlineLectureList/${cyberLecCode }"/>'>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button"
                        href='<c:url value="/student/cyber/${lecCode}/lectureNotice"/>'>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button"
                        href='<c:url value="/student/cyber/${cyberLecCode }/lectureDataList"/>'>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button"
                        href='<c:url value="/student/cyber/${cyberLecCode }/attendance"/>'>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button"
                        href='<c:url value="/student/cyber/${cyberLecCode }/task"/>'>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button"
                        href='<c:url value="/student/cyber/${cyberLecCode }/teamProject"/>'>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button"
                        href='<c:url value="/student/cyber/exam/exam"/>'>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button"
                        href='<c:url value="/student/cyber/${cyberLecCode }/objectionAppl"/>'>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button"
                        href='<c:url value="/student/cyber/${cyberLecCode }/grade"/>'>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button"
                        href='<c:url value="/student/cyber/${cyberLecCode }/lectureevaluation"/>'>
