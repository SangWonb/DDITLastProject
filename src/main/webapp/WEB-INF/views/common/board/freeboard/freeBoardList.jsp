										...
										<div class="flex d-flex flex-column">
											<p class="mb-0">
												...
												<c:choose>
													...
													<c:otherwise>
														<a
															href='<c:url value="/common/board/freeboard/freeBoardDetails?cmntCode=${l.cmntCode}"/>'>
...
$(document).on("click", ".js-secret-post", function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            if (inputPassword == correctPassword) {
                window.location.href = "${pageContext.request.contextPath}/common/board/freeboard/freeBoardDetails?cmntCode=" + cmntCode;
            } else {
                Swal.fire(
                    '오류',
                    '비밀번호가 일치하지 않습니다.',
	...
	$('#goToForm')
			.on(
					'click',
					function() {
						window.location.href = 'http://localhost/lcms/common/board/freeboard/fbForm';
					});
</script>