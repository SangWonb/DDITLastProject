...
<div class="mdk-header-layout__content page-content ">
	<div class="container page__container page-section">
		<div class="page-separator">
			<div class="page-separator__text">공지사항</div>
		</div>
			...
			<table class="table mb-0 thead-border-top-0 table-nowrap">
				...
				<tbody class="list" id="projects">
					<tr>
							...
							<div class="media-body">
								<div class="d-flex align-items-center">
									<div class="flex d-flex flex-column">
										<p class="mb-0">
											<a href="#" class="js-lists-values-lead btn-load-detail" data-notice-id="${academicNotice.cmntCode}">${academicNotice.cmntTitle}</a>
										</p>
									</div>
								</div>
							</div>
						...
						<td>
							<div class="d-flex flex-column">
								<small class="js-lists-values-status memName">${academicNotice.memName}</small>
							</div>
						</td>

						<td>
							<div class="d-flex flex-column">
								<small class="js-lists-values-budget cmntDate"><strong>${fn:substring(academicNotice.cmntDate, 0, 10)}</strong></small>
							</div>
						</td>

						<td>
							<div class="d-flex flex-column">
								<small class="js-lists-values-date cmntCount"><strong>${academicNotice.cmntCount}</strong></small>
							</div>
						</td>
					</tr>
				</tbody>
...
function loadNoticeDetail(noticeId) {
    $.ajax({
        type: 'GET',
        url: `\${cPath}/common/board/academicnotice/academicNoticeDetail/\${noticeId}`,
