...
<div style="width: 100%; background-color: #FFFFFF;">
	...
	<div
		...
		<button id="submitBtn" class="btn btn-primary"
			...
			<button id="autocompleteBtn">자동완성</button>
...
$(document).ready(function() {
    $('#autocompleteBtn').on('click', function() {
        ...
        quill.root.innerHTML = '도서 대여기간 관련 질문입니다.';
            $('#validationSample03').val('대여 기간이 너무 짧은거같아요.');
    });
});
			...
			.on(
					...
					function() {
						...
						$
								.ajax({
									type : "POST",
									url : "${pageContext.request.contextPath}/common/board/complaint/cpForm.do",
									data : formData,
