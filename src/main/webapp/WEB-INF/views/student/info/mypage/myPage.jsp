...
<div class="page-separator">
	<div class="page-separator__text">학생기초정보</div>
</div>
<div class="bg-white contentText">
		...
		<div class="form-row col" style="margin-top: 10px; margin-left: 5px;">
			...
			<div class="col">
				<input type="text" class="form-control" id="memNo"
					value="${sInfo.smemNo}" disabled="disabled">
			</div>
		</div>
		...
		<div class="form-row col" style="margin-top: 10px;">
			...
			<div class="col">
				<input type="text" class="form-control" id="memName"
					value="${sInfo.memName}" disabled="disabled">
			</div>
		</div>
		<div class="form-row col" style="margin-top: 10px;">
			<div class="col-4">
			...
			<div class="col">
				<input type="text" class="form-control" id="birthAndSex"
					value="${sInfo.bas}" disabled="disabled">
			</div>
		</div>
		<div class="form-row col" style="margin-top: 10px;">
			<div class="col-4">
			...
			<div class="col" style="margin-right: 5px;">
				<input type="text" class="form-control" id="memTel"
					value="${sInfo.memTel}" disabled="disabled">
			</div>
		</div>
	</div>
	...
	<div class="row row-cols-auto" style="margin-top:10px;">
		<div class="form-row col">
			<div class="col-3" style="margin-left: 5px;">
				<label class="form-label te1" for="cad">소속</label>
			</div>
			<div class="col">
				<input type="text" class="form-control" id="cad"
					value="${sInfo.cad}" disabled="disabled">
			</div>
		</div>
		<div class="form-row col">
			<div class="col-6">
			...
			<div class="col-5">
				<input type="text" class="form-control" id="semester"
					value="${sInfo.commonInfo.value}" disabled="disabled">
			</div>
		</div>
		<div class="form-row col">
			<div class="col-4">
			...
			<div class="col">
				<input type="text" class="form-control" id="stuJoinyear"
					value="${sInfo.stuJoinyear}" disabled="disabled">
			</div>
		</div>
		<div class="form-row col">
			<div class="col-3">
				<label class="form-label" for="stuChange2">변동</label>
			</div>
			<div class="col-8">
				<input type="text" class="form-control" id="stuChange2"
					value="${sInfo.stuChange2}" disabled="disabled">
			</div>
		</div>
		<div class="form-row col">
			<div class="col-3">
			...
			<div class="col-8">
				<input type="text" class="form-control" id=stuProg
					value="${sInfo.stuProg}" disabled="disabled">
			</div>
		</div>
	</div>
	<div class="card dashboard-area-tabs p-relative o-hidden mb-lg-32pt;"
		...
		<div class="card-header p-0 nav">
			<div class="row no-gutters" role="tablist">
				...
				<div style="margin-left: 1080px; margin-top: 7.5px;">
					<button id="modBtn" class="btn btn-primary float-right modBtnC"   
					  data-toggle="swal"
					  data-swal-title="수정하시겠습니까?"
					...
					<div 
					  ...
					  class="d-none"
					  data-swal-type="수정에 성공했습니다."
					  data-swal-title="수정에 실패했습니다.">
					</div>
				</div>
			</div>
		</div>
				...
				<form id="memInfo" method="post">
					<div
						...
						<div class="row row-cols-auto">
							<div class="form-row col" style="margin-top: 10px;">
								<div class="col-3">
									<label class="form-label formlabel" for="memNo">주민등록번호</label>
								</div>
								<div class="col">
									<input type="text" class="form-control" name="memReg1"
										value="${sInfo.memReg1}" disabled="disabled" />
								</div>
							</div>
							<div class="form-row col" style="margin-top: 10px;">
								<div class="col-2">
						...
						<div class="row row-cols-auto" style="margin-top: 10px;">
							<div class="form-row col">
								<div class="col-1">
									<label class="form-label formlabel" for="addr">주소</label>
								</div>
								<div
						...
						<div class="row row-cols-auto"
							...
							<div class="form-row col">
								<div class="col-1">
									<label class="form-label formlabel" for="memTel">전화번호</label>
								</div>
								<div style="margin-right: 5px;">
									<select id="memTel1" style="height: 35px;">
										...
										<c:forEach var="prefix" items="${prefixes}">
											<option value="${prefix}"
												<c:if test="${fn:startsWith(sInfo.memTel, prefix)}">selected</c:if>>${prefix}</option>
										</c:forEach>
									</select>
								</div>
								...
								<div class="col-1">
									<input type="text" class="form-control" id="memTel2"
										value="${fn:substring(sInfo.memTel,4,8)}" maxlength="4" />
								</div>
								<div style="text-align: center; margin-left: 10px; margin-right: 10px;">
									<span>-</span>
								</div>
								<div class="col-1"
									...
									<input type="text" class="form-control" id="memTel3"
										value="${fn:substring(sInfo.memTel,9,13)}" maxlength="4" />
								</div>
							</div>
						</div>
					</div>
					...
					<div style="background-color: rgb(245, 245, 245); width: 95%; margin-left: 2.5%; margin-bottom: 50px;">
					    ...
					    <div class="row align-items-end" style="padding: 10px;">
					        <div class="col-md-1">
					            <label for="memBank" class="labM">은행</label>
					        </div>
					        <div class="col-md-2">
					            <input type="text" class="form-control" id="memBank" value="${sInfo.memBank}">
					        </div>
					        <div class="col-md-1">
					            <label for="memBanknum" class="labM">계좌번호</label>
					        </div>
					        <div class="col-md-3">
					            <input type="text" class="form-control" id="memBanknum" value="${sInfo.memBanknum}">
					        </div>
					        <div class="col-md-1">
					            <label for="memDepo" class="labM">예금주</label>
					        </div>
					        <div class="col-md-2">
					            <input type="text" class="form-control" id="memDepo" value="${sInfo.memDepo}">
					        </div>
					    </div>
					</div>
				</form>
