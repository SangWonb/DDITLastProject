...
<c:forEach items="${gno }" var="g">
	<div class="container">
		<div style="margin-top: 10px;">${g.crtfPGno }</div>
	    <h1 class="hedtext">재 직 증 명 서</h1>
	    ...
	    <div class="bodytext">
	        <p>성&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;명 : ${proRecord.memName }</p>
	        <p>교&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;번 : ${proRecord.pmemNo }</p>
	        <p>학&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;과 : ${proRecord.deptName }</p>
	        <p>직&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;책 : ${proRecord.pmemPosition }</p>
	        <p>근&nbsp;&nbsp;무&nbsp;&nbsp;기&nbsp;&nbsp;간 : ${proRecord.startDate }</p>
	    </div>
	
	    <div class="bodytwo">
	        <p class="footertext">위 의&nbsp; 사 실 을&nbsp; 증 명 합 니 다.</p>
	        <p class="footerdate">${proRecord.today }</p>
