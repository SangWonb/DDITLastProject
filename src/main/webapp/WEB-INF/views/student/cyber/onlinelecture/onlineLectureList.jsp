					...
					<div class="media-body">
						...
						<div class="d-flex align-items-center">
							<div class="flex d-flex flex-column" style = "text-align: center;">
								<p class="mb-0">
									<strong class="js-lists-values-name"><a href="${pageContext.request.contextPath}/student/cyber/onlinelecture/onLineLectureDetail?lecoCode=${l.lecoCode}" >${l.lecoTitle}</a></strong>
