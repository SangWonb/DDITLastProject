...
const currentSmemNo = $("#stuDeailPage").data("currentSmemNo");
...
$("#attend").on("click",function(event){
	...
	$.ajax({
		url:window.location.pathname + "/attendDetail?smemNo="+currentSmemNo
		, method:"get"
		, dataType : "json"
...
$("#task").on("click",function(event){
	...
	$.ajax({
	    url: window.location.pathname + "/taskDetail?smemNo=" + currentSmemNo,
	    method: "get",
	    dataType: "json",
	    success: function (jsonObj) {
...
$("#teamproject").on("click",function(event){
	...
	$.ajax({
	    url: window.location.pathname + "/teamProjectDetail?smemNo=" + currentSmemNo,
	    method: "get",
	    dataType: "json",
	    success: function (jsonObj) {
...
$("#test").on("click",function(event){
	...
	$.ajax({
	    url: window.location.pathname + "/testDetail?smemNo=" + currentSmemNo,
	    method: "get",
	    dataType: "json",
	    success: function (jsonObj) {
...
function getStudentInfoData(){
	...
	$.ajax({
		url:window.location.pathname + "/stuGradeData?smemNo="+currentSmemNo
		, method:"get"
		, dataType : "json"
		, success:function(jsonObj){
